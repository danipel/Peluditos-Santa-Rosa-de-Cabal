...
export default function FormularioReporte({ onClose, onSave }) {
  ...
  async function submit(e) {
    e.preventDefault();
    if (!form.color.trim() || !form.sector.trim() || !form.telefono.trim())
      return;
    setEnviando(true);
      ...
      <Modal onClose={onClose} title="¡Reporte publicado!">
        <div style={{ fontSize: 13.5, lineHeight: 1.5 }}>
          <p>
            ...
            necesitas identificarte luego para editarlo:
          </p>
          <div
            style={{
              fontSize: 26,
